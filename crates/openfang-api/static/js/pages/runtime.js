    ...
    return {
      ...
      async loadData() {
        ...
        try {
          ...
          if (diff < 60) this.uptime = diff + '秒';
          else if (diff < 3600) this.uptime = Math.floor(diff / 60) + '分 ' + (diff % 60) + '秒';
          else if (diff < 86400) this.uptime = Math.floor(diff / 3600) + '小时 ' + Math.floor((diff % 3600) / 60) + '分钟';
          else this.uptime = Math.floor(diff / 86400) + '天 ' + Math.floor((diff % 86400) / 3600) + '小时';
